 ...
 */
public class Consumer_policy03 {
    public static void consumer_msg() {
        ...
        // 配置 分区分配策略 设置 RoundRobinAssignor 轮询分区  的策略
        conf.put(ConsumerConfig.PARTITION_ASSIGNMENT_STRATEGY_CONFIG, RoundRobinAssignor.class.getName());
        // 4. 主题名
