package com.spark_streaming.day_06_stream_subject.util
...
object JDBCUtil {
  ...
  def init(): DataSource = {
    ...
    properties.setProperty("url", "jdbc:mysql://hdp180:3306/sparkDB?useUnicode=true&characterEncoding=UTF-8")
    properties.setProperty("username", "root")
    properties.setProperty("password", "root")
    properties.setProperty("maxActive", "50") // 连接池  数量
